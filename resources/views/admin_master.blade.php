    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{URL::to('/dashboard')}}">
        <div class="sidebar-brand-icon">
          <img src="{{asset('back/img/logo/logo2.png')}}">
        </div>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePage" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('password.create')}}">Add Password</a>
            <a class="collapse-item" href="{{route('password.index')}}">All Password</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="{{asset('back/img/boy.png')}}" style="max-width: 60px">
